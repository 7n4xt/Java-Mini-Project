 ...
 */
public class LoseChapterDialog extends JDialog {
     ...
     */
    public LoseChapterDialog(JFrame parent, String title, String message, boolean isVictory) {
    ...
    private void initComponents(String message) {
        ...
        String titleText = isVictory ? "Félicitations!" : "Fin du voyage";
